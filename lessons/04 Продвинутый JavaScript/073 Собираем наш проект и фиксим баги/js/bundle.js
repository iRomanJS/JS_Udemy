...
function calc() {
    ...
    function getStatusInformation(selector, activeClass) {
        const elements = document.querySelectorAll(selector);
    ...
    getStatusInformation('#gender div', 'calculating__choose-item_active');
    getStatusInformation('.calculating__choose_big div', 'calculating__choose-item_active');
...
function modal(triggerSelector, modalSelector, modalTimerId) {
    ...
    const modallTrigger = document.querySelectorAll(triggerSelector),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-10-17');
