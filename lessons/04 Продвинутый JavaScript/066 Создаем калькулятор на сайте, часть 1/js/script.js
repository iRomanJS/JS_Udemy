window.addEventListener('DOMContentLoaded', () => {
    ...
    function getStatusInformation(parentSelector, activeClass) {
    ...
    getStatusInformation('#gender', 'calculating__choose-item_active');
    getStatusInformation('.calculating__choose_big', 'calculating__choose-item_active');
